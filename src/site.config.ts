...
export const theme: ThemeUserConfig = {
  ...
  description: '代码、记录与日常 · 追悔莫及之物皆美不胜收',
  /** The default favicon for your site which should be a path to an image in the `public/` directory. */
  favicon: '/favicon/favicon-light-32.png',
...
export const integ: IntegrationUserConfig = {
  ...
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: 'https://wojiecihuo.cn/' },
      { name: 'Avatar', val: 'https://wojiecihuo.cn/favicon/favicon-light-32.png' }
    ],
    // Cache avatars in `public/avatars/` to improve user experience.
    cacheAvatar: false
  },
  // [Search]
  pagefind: false, // Search is indexed by the checked build command.
