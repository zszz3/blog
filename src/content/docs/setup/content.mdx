...
```markdown title="src/content/posts/first-article.md"
---
...
If you have a lot of assets, you can create a folder for title like `src/content/posts/first-article/` and put all your assets in there. Of course, your content should be renamed to `index.md` or `index.mdx` and also be contained in this folder.
...
```markdown title="src/content/posts/simple-article.md"
---
...
Consider creating [content collections](https://docs.astro.build/en/guides/content-collections/) instead of pages for directories of related Markdown files that share a similar structure, such as blog posts or product items.
