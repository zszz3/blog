...
This theme has integrated it in `BlogPost.astro` by default, which means any content in `src/content/posts` doesn't need to import. If you want to use it in any other layout or page, you can use the following code:
